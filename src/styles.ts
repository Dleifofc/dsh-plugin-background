...
export const CSS = [
	...
	".dshbg-dot{width:6px;height:6px;flex:none;background:var(--dsw-alias-label-tertiary);border-radius:50%}",
	".dshbg-dot[data-active=true]{background:var(--dsw-static-deepseek-400)}",
	/* image strip */
